...
-- DropForeignKey
ALTER TABLE "ticket_history" DROP CONSTRAINT "ticket_history_changedById_fkey";
...
-- AddForeignKey
ALTER TABLE "ticket_history" ADD CONSTRAINT "ticket_history_changedById_fkey" FOREIGN KEY ("changedById") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
